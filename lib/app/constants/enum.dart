...
enum Hobby {
  ...
  static Hobby parseFromServer(String? value) {
    switch (value) {
      ...
      case "SKI_AND_SNOWBOARD":
        return Hobby.skiAndSnowboard;
      case "PLAYING_INSTRUMENTS":
