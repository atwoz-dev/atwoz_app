...
class FirebaseManager {
  ...
  Future<void> _registFcmHandlers() async {
  ...
  static Future<void> _firebaseMessagingBackgroundHandler(
    ...
    log('QQQ::: ${message.messageId} ${message.data} ${message.notification?.title} ${message.notification?.body} ${message.messageType}');
  }
