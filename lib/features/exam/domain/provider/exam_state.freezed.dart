...
mixin _$ExamState {
 ...
 QuestionData get questionList; SoulmateData get soulmateList; int get currentSubjectIndex; bool get isSubjectOptional; bool get isDone; bool get hasResultData; bool get hasSoulmate; bool get isLoaded; int get currentPage; Map<int, int> get currentAnswerMap; QuestionListErrorType? get error;
...
@override
int get hashCode => Object.hash(runtimeType,questionList,soulmateList,currentSubjectIndex,isSubjectOptional,isDone,hasResultData,hasSoulmate,isLoaded,currentPage,const DeepCollectionEquality().hash(currentAnswerMap),error);

@override
String toString() {
  return 'ExamState(questionList: $questionList, soulmateList: $soulmateList, currentSubjectIndex: $currentSubjectIndex, isSubjectOptional: $isSubjectOptional, isDone: $isDone, hasResultData: $hasResultData, hasSoulmate: $hasSoulmate, isLoaded: $isLoaded, currentPage: $currentPage, currentAnswerMap: $currentAnswerMap, error: $error)';
}
...
@useResult
$Res call({
 QuestionData questionList, SoulmateData soulmateList, int currentSubjectIndex, bool isSubjectOptional, bool isDone, bool hasResultData, bool hasSoulmate, bool isLoaded, int currentPage, Map<int, int> currentAnswerMap, QuestionListErrorType? error
});
...
/// Create a copy of ExamState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? questionList = null,Object? soulmateList = null,Object? currentSubjectIndex = null,Object? isSubjectOptional = null,Object? isDone = null,Object? hasResultData = null,Object? hasSoulmate = null,Object? isLoaded = null,Object? currentPage = null,Object? currentAnswerMap = null,Object? error = freezed,}) {
...
switch (_that) {
case _ExamState() when $default != null:
return $default(_that.questionList,_that.soulmateList,_that.currentSubjectIndex,_that.isSubjectOptional,_that.isDone,_that.hasResultData,_that.hasSoulmate,_that.isLoaded,_that.currentPage,_that.currentAnswerMap,_that.error);case _:
  return orElse();
...
@override
int get hashCode => Object.hash(runtimeType,questionList,soulmateList,currentSubjectIndex,isSubjectOptional,isDone,hasResultData,hasSoulmate,isLoaded,currentPage,const DeepCollectionEquality().hash(_currentAnswerMap),error);
