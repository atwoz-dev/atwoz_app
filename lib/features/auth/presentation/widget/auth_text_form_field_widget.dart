...
class _AuthTextFormFieldWidgetState
    extends AppBaseWidgetState<AuthTextFormFieldWidget> {
          ...
          builder: (context, value, child) => Visibility(
            ...
            child: Padding(
              ...
              child: Text(
                ...
                style: Fonts.body01Medium(palette.error),
              ),
            ),
          ),
        ),
    ...
    return InputDecoration(
      prefixIcon: ColorFiltered(
        colorFilter: ColorFilter.mode(
          widget.iconColor ?? palette.primary,
          BlendMode.srcIn,
        ),
        child: Padding(
