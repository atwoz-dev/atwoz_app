...
@freezed
abstract class InterviewAnswerUpdateRequest
    with _$InterviewAnswerUpdateRequest {
  const factory InterviewAnswerUpdateRequest({required String answerContent}) =
