...
_$ProfileDetailResponseImpl _$$ProfileDetailResponseImplFromJson(
...
Map<String, dynamic> _$$ProfileDetailResponseImplToJson(
        _$ProfileDetailResponseImpl instance) =>
    <String, dynamic>{
...
_$BasicMemberInformationImpl _$$BasicMemberInformationImplFromJson(
        Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$BasicMemberInformationImplToJson(
        _$BasicMemberInformationImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
...
_$MatchInformationImpl _$$MatchInformationImplFromJson(
        Map<String, dynamic> json) =>
    _$MatchInformationImpl(
...
Map<String, dynamic> _$$MatchInformationImplToJson(
        _$MatchInformationImpl instance) =>
    <String, dynamic>{
...
_$ProfileExchangeInfoImpl _$$ProfileExchangeInfoImplFromJson(
        Map<String, dynamic> json) =>
    _$ProfileExchangeInfoImpl(
      ...
      profileExchangeStatus: $enumDecode(
          _$ProfileExchangeStatusEnumMap, json['profileExchangeStatus']),
    );

Map<String, dynamic> _$$ProfileExchangeInfoImplToJson(
        _$ProfileExchangeInfoImpl instance) =>
    <String, dynamic>{
...
_$ProfileInterviewImpl _$$ProfileInterviewImplFromJson(
        Map<String, dynamic> json) =>
    _$ProfileInterviewImpl(
      content: json['content'] as String,
      category: json['category'] as String,
      answer: json['answer'] as String,
    );

Map<String, dynamic> _$$ProfileInterviewImplToJson(
        _$ProfileInterviewImpl instance) =>
    <String, dynamic>{
