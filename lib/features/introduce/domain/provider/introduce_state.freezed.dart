...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IntroduceState&&const DeepCollectionEquality().equals(other.introduceList, introduceList)&&const DeepCollectionEquality().equals(other.introduceMyList, introduceMyList)&&(identical(other.introduceLastId, introduceLastId) || other.introduceLastId == introduceLastId)&&(identical(other.myIntroduceLastId, myIntroduceLastId) || other.myIntroduceLastId == myIntroduceLastId)&&(identical(other.isLoaded, isLoaded) || other.isLoaded == isLoaded)&&(identical(other.error, error) || other.error == error));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(introduceList),const DeepCollectionEquality().hash(introduceMyList),introduceLastId,myIntroduceLastId,isLoaded,error);

@override
String toString() {
  return 'IntroduceState(introduceList: $introduceList, introduceMyList: $introduceMyList, introduceLastId: $introduceLastId, myIntroduceLastId: $myIntroduceLastId, isLoaded: $isLoaded, error: $error)';
}
...
@override@JsonKey() final  int? introduceLastId;
@override@JsonKey() final  int? myIntroduceLastId;
...
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_introduceList),const DeepCollectionEquality().hash(_introduceMyList),introduceLastId,myIntroduceLastId,isLoaded,error);
