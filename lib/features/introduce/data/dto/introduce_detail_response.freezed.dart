...
mixin _$MemberBasicInfoDTO {
 ...
 int get memberId; int get age; String get nickname; String get profileImageUrl; String get city; String get district; String get mbti; List<String> get hobbies; String get gender;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,memberId,age,nickname,profileImageUrl,city,district,mbti,const DeepCollectionEquality().hash(hobbies),gender);

@override
String toString() {
  return 'MemberBasicInfoDTO(memberId: $memberId, age: $age, nickname: $nickname, profileImageUrl: $profileImageUrl, city: $city, district: $district, mbti: $mbti, hobbies: $hobbies, gender: $gender)';
}
...
@useResult
$Res call({
 int memberId, int age, String nickname, String profileImageUrl, String city, String district, String mbti, List<String> hobbies, String gender
});
...
/// Create a copy of MemberBasicInfoDTO
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? memberId = null,Object? age = null,Object? nickname = null,Object? profileImageUrl = null,Object? city = null,Object? district = null,Object? mbti = null,Object? hobbies = null,Object? gender = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int memberId,  int age,  String nickname,  String profileImageUrl,  String city,  String district,  String mbti,  List<String> hobbies,  String gender)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MemberBasicInfoDTO() when $default != null:
return $default(_that.memberId,_that.age,_that.nickname,_that.profileImageUrl,_that.city,_that.district,_that.mbti,_that.hobbies,_that.gender);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int memberId,  int age,  String nickname,  String profileImageUrl,  String city,  String district,  String mbti,  List<String> hobbies,  String gender)  $default,) {final _that = this;
switch (_that) {
case _MemberBasicInfoDTO():
return $default(_that.memberId,_that.age,_that.nickname,_that.profileImageUrl,_that.city,_that.district,_that.mbti,_that.hobbies,_that.gender);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int memberId,  int age,  String nickname,  String profileImageUrl,  String city,  String district,  String mbti,  List<String> hobbies,  String gender)?  $default,) {final _that = this;
switch (_that) {
case _MemberBasicInfoDTO() when $default != null:
return $default(_that.memberId,_that.age,_that.nickname,_that.profileImageUrl,_that.city,_that.district,_that.mbti,_that.hobbies,_that.gender);case _:
  return null;
...
class _MemberBasicInfoDTO implements MemberBasicInfoDTO {
  const _MemberBasicInfoDTO({required this.memberId, required this.age, required this.nickname, required this.profileImageUrl, required this.city, required this.district, required this.mbti, required final  List<String> hobbies, required this.gender}): _hobbies = hobbies;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,memberId,age,nickname,profileImageUrl,city,district,mbti,const DeepCollectionEquality().hash(_hobbies),gender);
...
/// Create a copy of MemberBasicInfoDTO
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? memberId = null,Object? age = null,Object? nickname = null,Object? profileImageUrl = null,Object? city = null,Object? district = null,Object? mbti = null,Object? hobbies = null,Object? gender = null,}) {
