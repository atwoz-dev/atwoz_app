...
mixin _$NotificationListState {
  ...
  Set<int> get readIds => throw _privateConstructorUsedError;
...
abstract class $NotificationListStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<NotificationItem> notifications, Set<int> readIds});
}
...
class _$NotificationListStateCopyWithImpl<$Res,
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      readIds: null == readIds
          ? _value.readIds
          : readIds // ignore: cast_nullable_to_non_nullable
              as Set<int>,
    ) as $Val);
  }
}
...
class _$NotificationListStateImpl implements _NotificationListState {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other._readIds, _readIds));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(_readIds));
...
abstract class _NotificationListState implements NotificationListState {
  const factory _NotificationListState(
      ...
      final Set<int> readIds}) = _$NotificationListStateImpl;
