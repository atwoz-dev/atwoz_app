  ...
  Future<List<NotificationModel>> fetchNotifications() async {
    ...
    return Future.value([
      NotificationModel.create(
        ...
        recipientId: 101,
        date: DateTime.now(),
        type: const NotifiactionListItemType.request(),
        senderName: '차은우',
      ),
      NotificationModel.create(
        notificationId: 2,
        recipientId: 101,
        date: DateTime.now(),
        type: const NotifiactionListItemType.rejectProfile(),
        senderName: '마카롱조아',
      ),
      NotificationModel.create(
        notificationId: 3,
        recipientId: 101,
        date: DateTime.now(),
        type: const NotifiactionListItemType.message(),
        senderName: '차은우',
      ),
      NotificationModel.create(
        notificationId: 4,
        recipientId: 101,
        date: DateTime.now(),
        type: const NotifiactionListItemType.rejectHeart(),
        senderName: '마카롱조아',
      ),
      NotificationModel.create(
        notificationId: 5,
        recipientId: 101,
        date: DateTime.now(),
        type: const NotifiactionListItemType.match(),
        senderName: '마카롱조아',
      ),
      NotificationModel.create(
        notificationId: 6,
        recipientId: 101,
        date: DateTime.now(),
        type: const NotifiactionListItemType.notification(),
